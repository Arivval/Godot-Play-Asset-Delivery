...
public class PlayAssetDeliveryUtils {
    ...
    public static Dictionary convertAssetPackLocationToDictionary(AssetPackLocation AssetPackLocation) {
        throw new UnsupportedOperationException("Not implemented!");
    }

    public static Dictionary convertAssetPackLocationsToDictionary(Map<String, AssetPackLocation> AssetPackLocations) {
        throw new UnsupportedOperationException("Not implemented!");
    }
